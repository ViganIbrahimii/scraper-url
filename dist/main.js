    ...
    requestHandler: async (context) => {
        ...
        try {
            ...
            if (initialRequest === false) {
                ...
                const getCoordinatesAndRestaurantCount = (nextData) => {
                    if (!nextData ||
                        !nextData.props ||
                ...
                const { lat, lng, restaurantCount } = getCoordinatesAndRestaurantCount(nextData);
